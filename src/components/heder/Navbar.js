...
function Navbar(props) {
  return (
    <nav style={{padding:0}} className={`navbar sticky-top navbar-expand-lg ${props.light}`}>
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <Link to={"/about"} className={`nav-link ${props.light}`} href="#about">
                About
              </Link>
            </li>
            <li className="nav-item">
              <Link to={"/services"} className={`nav-link ${props.light}`} href="#">
                Services
              </Link>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
              <Link to={"/contact"} className={`nav-link ${props.light}`} href="#">
                Contact
              </Link>
            </li>
